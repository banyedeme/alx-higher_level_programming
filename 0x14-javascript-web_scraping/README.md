...
This project introduces learners to understanding Javascript web scraping using the request and fs modules. Additionally, the file I/O on Node.js and NPM request framework is used to interact with both the Star Wars and JSONplaceholder API's.
Learning Objectives
